...
int main(int argc, char* argv[]) {
  ...
  // testing.
  // Answer: 
  // The output displays 'filling with 100 or 1000 values' but 
  // if the array is not initialized with that I suppose in the 
  // loop its assigning an array index that doesnt exist
  fillArray(array, 10);
